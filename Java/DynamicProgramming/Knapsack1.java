/* $File: Knapsack1, $Timestamp: Tue Aug 10 00:28:28 2021 */
import java.io.*;
import java.nio.*;
...
public class Knapsack1 {
  ...
  private static Knapsack1 solver;
  ...
  public Knapsack1(FastScanner scan) {
    String[] NW = scan.nextLine().split("\\s+");
    ...
    for (int i = 0; i < N; i++) {
      ...
      w[i + 1] = Integer.parseInt(entry[0]);
      v[i + 1] = Integer.parseInt(entry[1]);
    }
    dp = new int[N + 1][W + 1];
    for (int i = 0; i <= W; i++)
      dp[0][i] = 0;
