/* $File: JavaStack, $Timestamp: Sat Aug  7 22:30:10 2021 */
import java.io.*;
import java.nio.*;
...
public class JavaStack {
  ...
  private static JavaStack solver;
  ...
  public JavaStack(FastScanner scan) {
    n = Integer.parseInt(scan.nextLine());
    list = new ArrayList<>(n);
    FastScanner entries = scan.scanLine();
    for (int i = 0; i < n; i++)
      list.add(entries.nextInt());
    stack = new Stack<>();
  }
